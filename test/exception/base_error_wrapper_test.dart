...
void main(){
  group('base error wrapper test', () {
    ...
    test("base error wrapper test implement OpenAIAuthError", () {
      final authError = OpenAIAuthError(data: OpenAIError(message: "",
        error: ErrorData.fromJson(null),),code: 404,);
      authError.toString();
      expect(authError, isA<BaseErrorWrapper>());
    });
    test("base error wrapper test implement OpenAIServerError", () {
      final serverError = OpenAIServerError(data: OpenAIError(message: "",
        error: ErrorData.fromJson(null),),code: 404,);

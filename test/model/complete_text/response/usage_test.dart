...
void main() {
  group('fromJson', () {
    ...
    test('should create a Usage object from a valid json with completion_tokens_details', () {
      final json = {
        "prompt_tokens": 50,
    ...
    test('should create a Usage object from a valid json with prompt_tokens_details', () {
      final json = {
        "prompt_tokens": 100,
  ...
  group('toJson', () {
    ...
    test('should serialize completion_tokens_details and reasoning_tokens correctly', () {
      final usage = Usage(
        50,
        30,
        80,
      ...
      expect(json['completion_tokens_details']['accepted_prediction_tokens'], 0);
      expect(json['completion_tokens_details']['rejected_prediction_tokens'], 0);
    });

    test('should serialize prompt_tokens_details and cached_tokens correctly', () {
      final usage = Usage(
        100,
        20,
        120,

...
void main() {
  group('edit response test', () {
    ...
    test('edit response test to json', () {
      final json = EditResponse(object: "object", created: 1, choices: [Choice.fromJson({"text":"text","index":1,})],
          usage: Usage.fromJson({"prompt_tokens":1,"completion_tokens":0,"total_tokens":1}),).toJson();

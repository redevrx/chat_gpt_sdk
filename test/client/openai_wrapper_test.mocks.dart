...
class _FakeBaseErrorWrapper_2 extends _i1.SmartFake
  ...
  _FakeBaseErrorWrapper_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockOpenAIClient extends _i1.Mock implements _i5.OpenAIClient {
  ...
  @override
  set log(_i2.Logger? value) => super.noSuchMethod(
    Invocation.setter(#log, value),
    ...
    Map<String, String>? headers,
      ...
      (super.noSuchMethod(
            Invocation.method(
              #delete,
              [url],
              {#onSuccess: onSuccess, #onCancel: onCancel, #headers: headers},
            ),
            returnValue:
                _i6.ifNotNull(
                  _i6.dummyValueOrNull<T>(
  ...
  _i3.Future<T> postRawBody<T>(
    String? url,
    Map<String, dynamic>? request, {
    required _i3.Future<T> Function(List<int>, String)? onSuccess,
    required void Function(_i7.CancelData)? onCancel,
    Map<String, String>? headers,
  }) =>
      (super.noSuchMethod(
  ...
  _i3.Stream<_i8.Response<dynamic>> postStream(
    ...
    required void Function(_i7.CancelData)? onCancel,
      ...
      (super.noSuchMethod(
            ...
            returnValueForMissingStub:
                _i3.Stream<_i8.Response<dynamic>>.empty(),
          )
    ...
    required void Function(_i7.CancelData)? onCancel,
      ...
      (super.noSuchMethod(
            Invocation.method(
              #sse,
              [url, request],
              {#complete: complete, #onCancel: onCancel},
            ),
            returnValue: _i3.Stream<T>.empty(),
            returnValueForMissingStub: _i3.Stream<T>.empty(),
          )
